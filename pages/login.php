...
<body class="d-flex justify-content-center align-items-center bg-light fs-5">
    <main class="bg-white rounded-4 p-4">
        <form class="d-flex flex-column gap-4" action="../processar/processarLogin.php" method="post">
            ...
            <div class="d-flex flex-column gap-4">
                ...
                <a href="enviarEmail.php" class="text-primary text-decoration-none">Esqueceu a senha?</a>
            </div>
